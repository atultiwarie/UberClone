      ...
      <main className="overflow-x-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mt-8 sm:mt-10">
              ...
              <div className="shadow-lg rounded-xl p-5 sm:p-6 bg-black/40">
                ...
                <p className="text-sm sm:text-base">
                  ...
                  expenses.¹ It is possible to manage expenditures and usage,
                  and operate under the established usage rules. For corporate
                  use, there are no fees or monthly fixed costs.
                </p>
              </div>
              ...
              <div className="shadow-lg rounded-xl p-5 sm:p-6 bg-black/40">
                ...
                <p className="text-sm sm:text-base">
                  ...
                  employees. In select cities, employees can enjoy a more
                  premium ride experience with options like Uber Premium and
                  Business Comfort.
                </p>
              </div>
            ...
            <div className="max-w-5xl mx-auto flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-12">
              ...
              <div className="lg:w-1/2 text-center lg:text-left">
                <p className="text-sm sm:text-base font-semibold mb-4 leading-relaxed">
                  ...
                  our first added benefits was providing Uber credit for rides,
                  so people could safely get a ride for work or for fun. We
                  encourage employees to spend the credits however they want.”
                </p>
        ...
        <div className="px-4 sm:px-8 lg:px-20 py-8">
          <div className="max-w-4xl mx-auto text-gray-600 text-sm sm:text-base space-y-4">
            ...
            <p>
              ¹Based on over 275 Uber for Business customers surveyed globally
              in February 2023. Customers agreed that they were able to reduce
              costs on ground transportation and/or meals through better
              compliance.
            </p>
            <p>
            ...
            <p>
              ³Based on a November 2021 survey commissioned by Uber, in which
              323 Uber for Business customers responded to the question “How
