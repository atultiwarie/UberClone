  ...
  return (
    <>
      ...
      <main className="overflow-x-hidden">
        ...
        {/* Drive Section */}
        <div className="flex flex-col lg:flex-row justify-between px-4 sm:px-6 lg:px-12 py-12 gap-10 items-center h-fit bg-black text-white">
          <div className="bg-center text-center lg:text-left w-full lg:max-w-2xl min-w-0">
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold leading-tight mb-5 break-words">
              Drive when you <br />
              want, make what <br />
              you need
            </h1>
            <p className="mt-10">Earn on your own schedule.</p>
            <div className="mt-5 flex flex-col sm:flex-row items-center gap-5 justify-center lg:justify-start">
          ...
          <div className="transform lg:-translate-y-6 w-full flex justify-center lg:justify-end min-w-0">
            <img
        ...
        {/* Why Drive Section */}
        <div className="py-10 px-4 sm:px-6 lg:px-10 mt-10">
          <h1 className="text-3xl font-bold mb-6 text-left mt-4 lg:ml-10">
            Why drive with us
          </h1>
          ...
          <div className="flex flex-col md:flex-row justify-around mt-10 text-center md:text-left gap-8 md:gap-6">
            <div>
        ...
        {/* Partner Section */}
        <div className="flex flex-col md:flex-row justify-center items-center gap-x-10 gap-y-8 px-4 sm:px-6 lg:px-10 mt-20">
        ...
        <div className="py-10 px-4 sm:px-6 lg:px-10">
          ...
          <div className="flex flex-col md:flex-row justify-around gap-6">
            <div className="max-w-sm min-w-0">
              ...
              <p>
                Each trip you take with the Uber app is insured to protect{" "}
                <br />
                you and your rider.
              </p>
            </div>
        ...
        <div className="relative h-[360px] sm:h-[420px] lg:h-[500px] w-full">
          <img
          ...
          <div className="relative z-10 flex flex-col justify-center h-full px-4 sm:px-6 lg:px-20 text-white">
        ...
        <div className="w-full p-5 sm:p-8 bg-gray-200">
          ...
          <div className="group flex flex-col sm:flex-row items-start sm:items-center gap-5 mt-10 sm:mt-20 mx-auto lg:ml-20 bg-white w-full max-w-3xl p-5 shadow transition-all duration-300 hover:shadow-md min-w-0">
            <img
            ...
            <div className="flex flex-col sm:ml-10 min-w-0">
              <p className="text-lg font-semibold">Download the Driver app</p>
              <p className="text-gray-600">Scan to download</p>
            </div>

            <div className="text-4xl ml-0 sm:ml-5 sm:text-3xl transform transition-transform duration-300 group-hover:translate-x-2 shrink-0">
        ...
        {/* Sign Up to Drive */}
        <div>
          <div className="flex items-center justify-between gap-4 px-4 sm:px-6 lg:px-10 mt-10 shadow transition-all duration-300 hover:shadow-md">
            <div>
              <p className="text-2xl sm:text-4xl font-bold p-4">
                Sign up to drive
              </p>
            </div>
            <div className="text-4xl sm:text-3xl transform transition-transform duration-300 hover:translate-x-2 cursor-pointer shrink-0">
              <FaArrowRight className="text-4xl" />
            </div>
          </div>
          <hr className="border-black border-t-2 mt-2 w-full max-w-[400px] mx-4 sm:mx-6 lg:mx-10" />

          <div className="px-4 sm:px-6 lg:px-10 mt-10 sm:mt-20">
            <p>
              ...
              delivery people on the Uber app who (i) have never <br />{" "}
              previously signed up to drive or deliver with Uber; (ii) receive
              this offer directly from Uber and see it in the guarantee tracker
              of the Uber Driver app; (iii) are cleared to drive or deliver{" "}
              <br /> with Uber; and (iv) complete the number of trips or
              deliveries displayed in the guarantee tracker in the city where
              they signed up to drive within the specified timeframe. Offer{" "}
              <br /> terms such as number of trips or deliveries and reward
              amount may vary by location. The guarantee offer that you see in
              the app replaces any guarantee amounts Uber previously <br />{" "}
              offered you.
            </p>
            <p className="mt-5">
              Earnings from your trips (after services fees and certain charges
              are deducted, such as city or local government charges) are
              included toward your guaranteed amount; any tips <br /> and
              promotions you make are on top of that amount. Earnings from your
              deliveries (after services fees and certain charges are deducted,
              such as city or local government charges) <br /> and Eats Boost
              promotions are included toward your offer amount; any tips and
              additional promotions you make are on top of that amount.
            </p>
            <p className="mt-5">
              ...
              is only valid for those who received it from Uber (via an email,
              an ad, a web page, or a unique referral link) <br />
              ...
              fraudulent, illegal, in error, or in violation of the <br />{" "}
              driver terms or these terms. Limited time only. Offer and terms
