      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-10 px-4 sm:px-8 lg:px-12 py-12">
        <div className="w-full lg:max-w-2xl">
          ...
          <div>
            ...
            <div className="relative ">
              <div className=" flex items-center bg-gray-200 rounded-xl text-center px-2 w-full">
                <ul className=" ml-2.5">
                  <FaCircleDot />
                </ul>
                <input
              ...
              <div className=" flex items-center bg-gray-200 rounded-xl text-center px-2 mt-5 w-full">
        ...
        <div className="w-full lg:w-auto flex justify-center lg:justify-end">
          <img
            ...
            alt=""
            srcset=""
            className="w-full max-w-[420px] lg:max-w-[550px] h-auto"
          />
        </div>
      </div>
    </>
