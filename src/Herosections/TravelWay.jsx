  ...
  return (
    <>
      <div className="my-20 sm:my-32">
        <h1 className="px-4 sm:px-6 lg:px-32 text-3xl sm:text-4xl font-semibold">
          Use the Uber app to help you travel your way
        </h1>
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 px-4 sm:px-6 lg:px-32 mt-10">
          <div className="w-full lg:max-w-sm">
            ...
            <button className=" bg-black text-white text-lg font-bold mt-8 py-3 px-10 rounded-xl cursor-pointer hover:bg-gray-800">
              Search ride options
            </button>
          </div>
