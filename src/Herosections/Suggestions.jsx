...
function Suggestions() {
  return (
    <>
      <div>
        <h1 className="text-3xl sm:text-4xl font-bold mb-6 px-4 sm:px-6 lg:px-20">
          Suggestion
        </h1>
        <div className="px-4 sm:px-6 lg:px-20">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="flex flex-col sm:flex-row bg-neutral-100 rounded-xl overflow-hidden w-full">
              <div className="p-6">
