...
function Business_2Way() {
  return (
    <>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-7xl mx-auto">
          <div className="  p-6 flex flex-col items-center text-center">
            ...
            <h2 className="text-xl font-bold mb-4 text-gray-800">
              A self-serve approach to get set up in minutes
            </h2>
            <ul className="list-disc pl-5 text-left text-lg space-y-2 text-gray-600 max-w-md">
              ...
              <li>
                Streamlined expensing, and the ability to pay with one credit
                card with no signup fees
              </li>
              <li>
                Access to dashboard features, including integrations with
                leading expense platforms, sustainability metrics, and customer
                support
              </li>
            </ul>
          </div>
          ...
          <div className="   p-6 flex flex-col items-center text-center">
            ...
            />
            <h2 className="text-xl font-bold mb-4 text-gray-800">
              A tailored experience to fit your company’s needs
            </h2>
            <ul className="list-disc pl-5 text-left text-lg space-y-2 text-gray-600 max-w-md">
              <li>For companies with more than 250 employees</li>
              <li>
                Streamlined expensing, ability to manage multiple payment
                methods, invoicing support, and no signup fees
              </li>
              <li>
                Access to dashboard features, including integrations,
                sustainability metrics, and a dedicated support team
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className=" mt-20">
        <div className="px-4 sm:px-8 lg:px-32 space-y-3">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-800">
            Not quite ready to get started?
          </h1>
          <p className="max-w-4xl text-base sm:text-xl text-gray-500 font-semibold">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            <div className="  p-6 hover:shadow-lg transition duration-300">
              ...
              <p className="text-gray-600">
                Learn more about the power of Uber for Business in everyday
                business and how our global platform can offer custom solutions.
              </p>
            </div>
            ...
            <div className=" p-6 hover:shadow-lg transition duration-300">
              ...
              <p className="text-gray-600">
                Discover how Uber for Business supports employee mobility and
                business travel worldwide with scalable tools and insights.
              </p>
            </div>
            ...
            <div className="  p-6 hover:shadow-lg transition duration-300">
              ...
              <p className="text-gray-600">
                Learn how your company can track and reduce its carbon footprint
                using Uber’s platform and sustainability tools.
              </p>
            </div>
          </div>
        </div>
