...
function ExploreRideOpt() {
  return (
    <>
      ...
      {/* HeroSections */}
      <div className="flex flex-col lg:flex-row items-center justify-between gap-10 px-4 sm:px-8 lg:px-12 py-12">
        <div className="w-full lg:max-w-2xl">
          <div>
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold mb-4 p-2 w-full max-w-[500px] leading-tight">
              Go with Uber
            </h1>
          </div>
          <div>
            <p className="text-base sm:text-lg p-2 w-full max-w-[500px]">
              Find a ride for every road with access in more than 10,000 cities
              worldwide.
            </p>
            ...
            <div className="relative ">
              <div className="flex items-center bg-gray-200 rounded-xl text-center px-2 w-full max-w-[500px]">
                <ul className=" ml-2.5">
                  <FaCircleDot />
                </ul>
                <input
                  ...
                  className="w-full p-4 rounded-2xl bg-gray-200 mt-2 outline-0"
                />
              ...
              <div className="flex items-center bg-gray-200 rounded-xl text-center px-2 mt-5 w-full max-w-[500px]">
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-7 mt-3.5 pt-2">
        ...
        <div className="w-full lg:w-auto flex justify-center lg:justify-end">
          <img
            ...
            alt=""
            srcset=""
            className="w-full max-w-[420px] lg:max-w-[600px] h-auto"
          />
        </div>
      </div>
      ...
      <div className="flex flex-col lg:flex-row px-4 sm:px-8 lg:px-32 py-16 gap-10 lg:gap-20">
        <div className="w-full lg:max-w-2xl mt-2 lg:mt-10">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-800">
            Commute in Comfort with Uber Shuttle
          </h1>
          <p className="text-base sm:text-lg text-gray-800 mt-6 sm:mt-14">
            Uber Shuttle is a new way to enjoy a comfortable, safe, and
            convenient commute in Delhi. There’s no need to wait to hail down
            and squeeze onto a crowded bus, spend hours in the metro or drive in
            peak traffic.
          </p>
        </div>
      ...
      <div className="px-4 sm:px-8 lg:px-24 py-10">
        ...
        {/* Part-1 */}
        <div className="grid grid-cols-1 lg:grid-cols-2 mt-14 gap-10">
          <div>
            <img
            ...
            <h2 className=" text-xl font-semibold mt-5">
              Ride with Uber in 10,000+ cities
            </h2>
            <p className=" text-lg text-gray-600 mt-2.5 ">
              Travel around cities worldwide, with access to rides almost
              everywhere.
            </p>
          </div>
          ...
          <div>
            ...
            />
            <h2 className=" text-xl font-semibold mt-5">
              Get a ride at 700+ airports
            </h2>
            <p className=" text-lg text-gray-600 mt-2.5">
              The world is ready for your arrival. Start your travels with a
              ride to the airport. In most regions you’ll also have the option
              to schedule an airport pickup or dropoff in advance.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-14 gap-10">
          ...
          <div>
            ...
            <p className=" text-lg text-gray-600 mt-2.5 ">
              Move toward a greener future with eco-friendly ride options. It’s
              the perfect way to be a more conscious traveler.
            </p>
          </div>
          ...
          <div>
            ...
            <p className=" text-lg text-gray-600 mt-2.5">
              We’ve introduced new policies and features to help keep everyone
              safe, including a mandatory mask policy and free disinfectant
          ...
          <div>
            ...
            <p className=" text-lg text-gray-600 mt-2.5">
              See and do it all with one membership that lets you save on all
              your rides and eats
            </p>
          </div>
        </div>
